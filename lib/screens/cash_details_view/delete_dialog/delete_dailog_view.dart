...
class DeleteCashBookDialog{
  static Future<bool> showDeleteCashBookDialog(
            ...
            listener: (context, state) {
              switch (state.status) {
                ...
                case GlobalApiStatus.completed:
                  if (state is DeleteCashBookStateSuccess) {
                    ...
                    children: [
                      ...
                      Row(
                        ...
                        children: [
                          ...
                          GestureDetector(
                            onTap: () async {
                              context.read<CashbookBloc>().add(DeleteCashBookEvent(cashBookId: cashBookId));
                            },
                            child: Padding(
                              padding: const EdgeInsets.only(right: 15.0),
                              child: Utility.subTitle(
