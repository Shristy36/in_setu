...
import 'package:in_setu/views/material_view/material_stock_summary_screen.dart';
            ...
            children: [
              ...
              Expanded(
                child: TabBarView(
                  ...
                  children: [_buildStocksContent(), _buildIndentsContent()],
                ),
              ),
  ...
  Widget _buildTabBar() {
    return Container(
      ...
      child: TabBar(
        ...
        isScrollable: false, // This ensures tabs don't scroll and take equal space
        indicatorSize: TabBarIndicatorSize.tab, // Indicator matches tab width
        tabs: [
          Tab(
            text: 'Stocks',
            // Remove Padding and let TabBar handle the width
          ),
          Tab(
            text: 'Indents',
            // Remove Padding and let TabBar handle the width
