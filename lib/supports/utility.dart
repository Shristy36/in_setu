...
class Utility {
  ...
  static Widget getCustomToolbar(
    String title,
    Color titleColor,
    BuildContext context,
  ) {
  ...
  static Widget getButtonDesign(String txt) {
    return Container(
      ...
      child: Center(child: subTitle(txt, AppColors.colorWhite)),
    );
  }
  ...
  static void showFlutterToast(String msg, {BuildContext? context}) {
    try {
      ...
      Fluttertoast.showToast(
        ...
        // Use direct color for testing
        textColor: AppColors.colorBlack,
        fontSize: 14.0,
        webShowClose: true,
        // For web platform
        webBgColor:
            "linear-gradient(to right, #00b09b, #96c93d)", // Web specific
      );
    } catch (e) {
        ...
        child: RichText(
          ...
          text: TextSpan(
            ...
            children: [
              const TextSpan(
                text:
                    "By submitting my information, I acknowledge and accept the ",
              ),
              TextSpan(
                text: "Privacy Policy",
  ...
  static Widget getLoadingView(BuildContext context) {
    return Center(
